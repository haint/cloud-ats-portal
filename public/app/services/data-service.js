    ...
    function($http, $q, $cookies, $rootScope, $window, $state){
      return {
        ...
        list: function(tenant, space) {
          ...
          var request = {
            method: 'GET',
            url: 'http://localhost:8001/api/v1/data/list/' + tenant + '/' + space,
            headers: {
              'X-AUTH-TOKEN': $cookies.get('authToken')
            }
          };
        ...
        dataSet: function (id) {
          ...
          var request = {
            method: 'GET',
            url: 'http://localhost:8001/api/v1/data/dataSet/' + id,
        ...
        deleteDataSetById: function (id, callback) {
          var request = {
            method: 'DELETE',
            url: 'http://localhost:8001/api/v1/data/delete/' + id,
        ...
        update: function (id, name, dataset, callback) {
          var request = {
            method: 'PUT',
            url: 'http://localhost:8001/api/v1/data/update',
            headers: {
              'X-AUTH-TOKEN': $cookies.get('authToken')
            },
            data: {
